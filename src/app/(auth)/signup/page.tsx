  ...
  return (
    <div className="w-full max-w-md p-0">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-[color:var(--color-text-primary)] mb-2">Sign Up Account</h2>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-[color:var(--background)] px-2 text-[color:var(--color-text-secondary)]">Or</span>
        </div>
      </div>
      <SignUpForm />
    </div>
